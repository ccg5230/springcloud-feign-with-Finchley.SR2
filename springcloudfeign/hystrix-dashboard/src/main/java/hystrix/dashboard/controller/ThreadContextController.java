package hystrix.dashboard.controller;


import hystrix.dashboard.config.HystrixThreadLocal;
import hystrix.dashboard.service.IThreadContextService;
...
/**
 * 测试Hystrix并发策略：线程池线程隔离，另外一种是信号量隔离
 */
@RestController
...
public class ThreadContextController {
    ...
    public String getUser(@PathVariable("id") Integer id) {
		...
		RequestContextHolder.currentRequestAttributes().setAttribute("userId", "userId : "+ id,
