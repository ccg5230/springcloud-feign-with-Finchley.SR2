...
insert  into `zuul_route`(`id`,`path`,`service_id`,`url`,`strip_prefix`,`retryable`,`enabled`,`description`) values ('erer','/bokee/**',NULL,'http://www.bokee.com/',1,0,1,'重定向到博客网被引导到维护页面啦，试了许多网站报403、502错误');
